    ...
    return (<div className="GameplayDescription-container">
        ...
        <div className="GameplayDescription-part1">
            <div className="GameplayDescription-box">
                <div className="GameplayDescription-box-title">
                    Попадая в мир красных панд ты должен расчистить свою деревню и начать строительство:
                </div>
                <div className="GameplayDescription-content">
                    <div className="GameplayDescription-text-container">
            ...
            <div className="GameplayDescription-box">
                <div className="GameplayDescription-box-title">
                    Развивай свою деревню METOLAND собирая:
                </div>
                <div className="GameplayDescription-content">
                    <div className="GameplayDescription-text-container">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
        ...
        <div className="GameplayDescription-part2">
            <div className="GameplayDescription-box full">
                <div className="GameplayDescription-text">
                    И <span>самое главное</span> ты можешь ускорить добычу всех ресурсов, строительство всех зданий и
                    самое приятное,
                    добычу токена МЕТО используя нашу коллекцию игровых НФТ.
                </div>
            </div>
        </div>
    </div>)
