    ...
    return (<footer className="footer">
        ...
        <div className="botmenu">
            <ul>
                ...
                <li>
                    <a className="link" href="https://metoshi.com/finance.html">{intl.formatMessage({id:'footer_red_panda'})}</a>
                </li>
                <li>
                    <a className="link" href="https://metoshi.com#tokenomics">{intl.formatMessage({id:'footer_tokenomics'})}</a>
                </li>
                <li>
                ...
                <li>
                    <a className="link" href="https://metoshi.com#contacts">{intl.formatMessage({id:'footer_contacts'})}</a>
                </li>
            </ul>
        </div>
        <div id="bot_r">
