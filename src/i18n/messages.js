...
export const messages = {
    [LOCALES.RUSSIAN]: {
        ...
        faq_item_content1: 'Метоленд — игра, в которой вы можете зарабатывать токены, просто играя. Ваша задача — собрать у себя в поселении как можно больше панд, ухаживать за ними и повышать уровень их счастья',
        faq_item_title2: 'Что такое сундук строителя?',
        faq_item_content2: 'Открыв сундук строителя, вы получите одного из уникальных строителей, который даст бонус, ускоряющий строительство зданий. Всего будет выпущено 500 строителей: 250 обычных, 150 редких и 100 эпических',
        faq_item_title3: 'Что такое сундук фермера?',
        faq_item_content3: 'Открыв сундук фермера, вы получите одного из уникальных фермеров, который будет увеличивать количество добываемой на ферме еды для ваших панд. Всего будет выпущено 500 фермеров: 250 обычных, 150 редких и 100 эпических',
        faq_item_title4: 'Что такое сундук лесоруба?',
        faq_item_content4: 'Открыв сундук лесоруба, вы получите одного из уникальных лесорубов, который будет увеличивать количество добываемой на лесопилке древесины, необходимой для строительства других построек. Всего будет выпущено 500 лесорубов: 250 обычных, 150 редких и 100 эпическихs',
        faq_item_title5: 'Что такое сундук копателя?',
        faq_item_content5: 'Открыв сундук копателя, вы получите одного из уникальных копателей, который будет увеличивать количество добываемой в карьере глины, необходимой для строительства других построек. Всего будет выпущено 500 старателей: 250 обычных, 150 редких и 100 эпических',
        ...
        gameplay_description_box1_item2: 'A rock quarry',
